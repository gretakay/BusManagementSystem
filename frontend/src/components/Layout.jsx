  ...
  return (
    <>
      ...
      <div className="hidden lg:flex h-screen bg-gray-100">
        {/* 桌面版側邊欄 */}
        <div className="w-80 bg-gradient-to-b from-purple-50 to-indigo-50 border-r border-gray-200 flex-shrink-0">
          <div className="h-full flex flex-col">
            {/* Logo 區域 */}
            <div className="flex items-center h-20 px-6 bg-gradient-to-r from-purple-500 to-indigo-600 flex-shrink-0">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-white/20 rounded-xl flex items-center justify-center">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
            ...
            {/* 用戶信息 */}
            <div className="px-6 py-6 border-b border-purple-200 flex-shrink-0">
              <div className="flex items-center space-x-4">
                <div className="relative">
                  <div className="h-12 w-12 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-xl flex items-center justify-center shadow-lg">
                    <span className="text-lg font-bold text-white">
            ...
            {/* 登出按鈕 */}
            <div className="p-4 border-t border-purple-200 flex-shrink-0">
              <button
                onClick={handleLogout}
                className="flex items-center w-full px-4 py-3 text-sm font-medium text-gray-700 rounded-xl hover:bg-red-50 hover:text-red-700 transition-all duration-200 group"
              >
