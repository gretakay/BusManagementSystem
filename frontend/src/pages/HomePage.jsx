      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
        <div className="w-full px-4 sm:px-6 lg:px-8 py-4 lg:py-6">
          ...
          <div className="mb-4 lg:mb-6">
            <div className="bg-white/80 backdrop-blur-lg rounded-2xl lg:rounded-3xl p-4 lg:p-6 shadow-xl border border-white/20">
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                <div className="mb-3 lg:mb-0">
                  <h1 className="text-xl lg:text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-1 lg:mb-2">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-3">
                  ...
                  <div className="flex items-center space-x-2 px-3 py-1.5 bg-gradient-to-r from-blue-100 to-purple-100 rounded-lg lg:rounded-xl">
          ...
          <div className="space-y-4 lg:space-y-6">
            ...
            {isLeader && (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  {myBuses.length > 0 && (
                    <div className="text-xs lg:text-sm text-gray-500 bg-gray-100 px-2 py-1 rounded-full">
                      {myBuses.length} 輛車輛
                    </div>
                  )}
                </div>
                ...
                {myBuses.length === 0 ? (
                  <div className="bg-white/80 backdrop-blur-lg rounded-2xl lg:rounded-3xl p-6 lg:p-8 text-center shadow-xl border border-white/20">
                    <div className="mb-4">
                      <div className="w-16 h-16 lg:w-20 lg:h-20 bg-gradient-to-r from-blue-100 to-purple-100 rounded-2xl lg:rounded-3xl flex items-center justify-center mx-auto mb-3">
                        <svg className="w-8 h-8 lg:w-10 lg:h-10 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 9l4-4 4 4m0 6l-4 4-4-4" />
                        </svg>
                      </div>
                      <h3 className="text-lg lg:text-xl font-semibold text-gray-900 mb-2">目前沒有分配到車輛</h3>
                      <p className="text-gray-500 text-sm lg:text-base">請聯絡管理員進行車輛分配</p>
                    </div>
                  </div>
                ) : (
                  <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-3 lg:gap-4">
                    {myBuses.map((bus) => (
                      <div key={bus.id} className="group bg-white/80 backdrop-blur-lg rounded-2xl lg:rounded-3xl p-4 lg:p-5 shadow-xl border border-white/20 hover:shadow-2xl hover:scale-105 transition-all duration-300">
                        <div className="flex items-center justify-between mb-3">
                          <h3 className="text-base lg:text-lg font-bold text-gray-900">{bus.name}</h3>
                          <span className="text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded-full">{bus.tripName}</span>
                        </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4">
                {isLeader && (
                  <a href="/scan" className="group bg-white/80 backdrop-blur-lg rounded-2xl lg:rounded-3xl p-4 lg:p-5 text-center hover:shadow-xl hover:scale-105 transition-all duration-300 border border-white/20">
                    <div className="w-12 h-12 lg:w-14 lg:h-14 bg-gradient-to-r from-blue-100 to-blue-200 rounded-xl lg:rounded-2xl flex items-center justify-center mx-auto mb-2 lg:mb-3 group-hover:scale-110 transition-transform">
                    ...
                    <p className="text-xs lg:text-sm font-bold text-gray-900">掃碼</p>
                  </a>
                )}
                
                {isAdmin && (
                  <>
                    <a href="/people/new" className="group bg-white/80 backdrop-blur-lg rounded-2xl lg:rounded-3xl p-4 lg:p-5 text-center hover:shadow-xl hover:scale-105 transition-all duration-300 border border-white/20">
                      <div className="w-12 h-12 lg:w-14 lg:h-14 bg-gradient-to-r from-green-100 to-green-200 rounded-xl lg:rounded-2xl flex items-center justify-center mx-auto mb-2 lg:mb-3 group-hover:scale-110 transition-transform">
                        <svg className="w-6 h-6 lg:w-7 lg:h-7 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
                      </div>
                      <p className="text-xs lg:text-sm font-bold text-gray-900">新增人員</p>
                    </a>
                    <a href="/trips/new" className="group bg-white/80 backdrop-blur-lg rounded-2xl lg:rounded-3xl p-4 lg:p-5 text-center hover:shadow-xl hover:scale-105 transition-all duration-300 border border-white/20">
                      <div className="w-12 h-12 lg:w-14 lg:h-14 bg-gradient-to-r from-purple-100 to-purple-200 rounded-xl lg:rounded-2xl flex items-center justify-center mx-auto mb-2 lg:mb-3 group-hover:scale-110 transition-transform">
                        <svg className="w-6 h-6 lg:w-7 lg:h-7 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3a2 2 0 012-2h4a2 2 0 012 2v4m-4 8v6m-4-3v3m8-3v3m4-6a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                      </div>
                      <p className="text-xs lg:text-sm font-bold text-gray-900">新增行程</p>
                    </a>
                    <a href="/reports" className="group bg-white/80 backdrop-blur-lg rounded-2xl lg:rounded-3xl p-4 lg:p-5 text-center hover:shadow-xl hover:scale-105 transition-all duration-300 border border-white/20">
                      <div className="w-12 h-12 lg:w-14 lg:h-14 bg-gradient-to-r from-orange-100 to-orange-200 rounded-xl lg:rounded-2xl flex items-center justify-center mx-auto mb-2 lg:mb-3 group-hover:scale-110 transition-transform">
                        <svg className="w-6 h-6 lg:w-7 lg:h-7 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                        </svg>
                      </div>
                      <p className="text-xs lg:text-sm font-bold text-gray-900">查看報表</p>
                    </a>
                  </>
                )}
              </div>
